			...
			<div class="float-container card">
				...
				<div class="float-left w-25">
					<a href="/cuddly/product/detail?productNo=${qnaDto.productNo}">
						<img
						src="/cuddly/image/product/main?productNo=${qnaDto.productNo}"
						width="120" height="120" class="image image-round">
					</a>
				</div>

				<div class="row flex-container auto-width">
					<span class="left">상품문의번호 : ${qnaDto.qnaNo}</span> <span
						class="right me-10">작성일 : ${qnaDto.qnaDate}</span>
				</div>
				...
				<c:choose>
					<c:when test="${qnaDto.qnaAnswer == null}">
						<div class="row left">
							<input id="answer" name="qnaAnswer" autocomplete="off"
								placeholder="미등록" style="border: none; width: 440px">
						</div>
					</c:when>
					<c:otherwise>
						<div class="row left">
							답변 : <input id="answer" name="qnaAnswer" autocomplete="off"
								readonly="readonly" value="${qnaDto.qnaAnswer}"
