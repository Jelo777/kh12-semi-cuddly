        ...
        <div class="center w-400">
            ...
            <div class="row left">
                ...
                <input type="password" id="password-check" 
                        placeholder="비밀번호 한 번 더 입력" class="form-input underline-input w-100">
            ...
            <input type="text" name="memberEmail" 
                    placeholder="test@kh.com" class="form-input underline-input w-100">
            ...
            <div class="row flex-container">
	            ...
	            <div class="cert-wrapper right">
			        <input type="text" class="form-input underline-input cert-input w-50">
            ...
            <div class="row left">
                <label>생년월일</label>
                <input type="date" name="memberBirth" class="form-input underline-input w-100">
