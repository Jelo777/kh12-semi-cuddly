	...
	<section>
		<aside>
             <div class="flex-container vertical center w-200">
				...
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/orders/list">구매내역</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/review/memberList">나의 리뷰</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/member/mypage/wishlist">관심상품</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/qna/memberList">상품문의</a>
					</h3>
				</div>
				...
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/member/change">개인정보수정</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/member/password">비밀번호 변경</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/member/address/list">배송지 관리</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/member/logout">로그아웃</a>
					</h3>
				</div>
				<div class="row left">
					<h3 class="ms-20">
						<a class="link" href="${pageContext.request.contextPath}/member/exit">탈퇴</a>
					</h3>
				</div>
